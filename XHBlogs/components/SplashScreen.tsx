...
export default function SplashScreen() {
  ...
  const [avatarUrl, setAvatarUrl] = useState<string>(siteConfig.avatarUrl);
  const [authorName, setAuthorName] = useState<string>(siteConfig.authorName);
    ...
    fetch('/api/config')
      ...
      .then(d => {
        if (d?.success && d.data) {
          ...
          if (d.data.authorName) setAuthorName(d.data.authorName);
        }
      })
      .catch(() => {});
            ...
            <div className="relative w-24 h-24 mb-8">
              ...
              <div className="relative w-full h-full rounded-full p-1.5 bg-white dark:bg-slate-900 shadow-xl">
                {avatarUrl ? (
                  ...
                  <div className="w-full h-full rounded-full bg-gradient-to-tr from-indigo-400 to-purple-400 flex items-center justify-center text-white text-2xl font-bold">
